...
class DotGraph(Graph):
                            ...
                            if type == "provider":
                                ...
                                if ("not available" in self.cost.resource_cost_info):
                                    ...
                                    for i in range(len(self.cost.resource_cost_info)):
                                        self.total_cost = self.cost.resource_cost_info[i]["totalcost"]
    ...
    def totalCost(self):
        totalcost = None
        for i in range(len(self.cost.resource_cost_info)):
            totalcost = self.cost.resource_cost_info[i]["totalcost"]
    ...
    def dot(self):
        ...
        if self.flag == "ext":
            print("here cost is:******",self.totalcost)
